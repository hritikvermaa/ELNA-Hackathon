  ...
  return (
    <div>
      <section className="flex flex-col justify-between h-[100vh]">
        ...
        <section className="m-2 bg-[#121212] text-white p-2 rounded-sm shadow-md backdrop-filter backdrop-blur-xl bg-opacity-60 border-[1px] border-gray-500 h-[100%] sm:flex sm:justify-center flex sm:flex-row flex-col items-center">
          <Link
            to="/"
