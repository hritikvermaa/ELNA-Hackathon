...
const Header = () => {
  ...
  return (
    <div className="bg-[#121212] p-2 text-white rounded-sm shadow-md backdrop-filter backdrop-blur-xl bg-opacity-60 border-[1px] border-gray-500 flex sm:flex-row sm:justify-between sm:items-center flex-col gap-5 sm:gap-0">
     
    <p className="font-medium font-serif text-[#50d71e] italic decoration-4 hover:list-disc">CrowdFunding</p>
      <p className="bg-[#121212] outline-none border-[1px] border-[#2effaf] p-2 rounded-[5px] ">
