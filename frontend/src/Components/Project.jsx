  ...
  return (
    <div>
      <section className="flex flex-col justify-between h-[100vh]">
        ...
        <section className="m-2 bg-[#121212] text-white p-2 rounded-sm shadow-md backdrop-filter backdrop-blur-xl bg-opacity-60 border-[1px] border-gray-500 h-[100%] flex justify-between items-center gap-5">
          <Link
            to="/"
          ...
          <div className="flex flex-col w-[50%] gap-5">
            ...
            <input
              type="text"
              className="bg-[#3d5165] rounded-md p-3 outline-none"
              readOnly={true}
            ...
            {Loader2 ? (
              ...
              <button
                className="p-3 bg-red-800 rounded-md hover:ring-red-500 outline-none"
                onClick={Abort}
                disabled={Data?.data && Data?.data[6] == false ? true : false}
              >
                Abort Campaign
